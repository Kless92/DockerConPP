...
def infoCou():
    return '<h1>/courses  GET</h1><h2>* retrieve all information on courses.</h2><h1>/courses/id GET</h1><h2>* retrieves course information base on selected id</h2><h1>/courses  POST</h1><h2>*  Create new course row if the requirment are meet.</h2><h1>/courses  DELETE</h1><h2>*  Delete a existing course, if one exist.</h2><h1>/courses/id PUT</h1><h2>* Edit slected course if it exist.</h2><h1>/courses/id/students  GET</h1><h2>* Retrieves all students info that are signup for selected course, if there are any</h2><h1>/coursesidpro_course  GET</h1><h2>Retrieves professor that will teach selected course, if one is assigned</h2><h1>/coursesidroom  GET</h1><h2>* Retrieves building info that the course will be in, if one is assigned</h2>'
@app.route('/buildings/info')
def infoBul():
    return '<h1>/buildings  GET</h1><h2>* retrieve all information on buildings.</h2><h1>/buildings/id GET</h1><h2>* retrieves building information base on selected id</h2><h1>/buildings  POST</h1><h2>*  Create new building infomation if the requirment are meet.</h2><h1>/buildings  DELETE</h1><h2>*  Delete a existing building information, if one exist.</h2><h1>/buildings/id PUT</h1><h2>* Edit slected building, if it exist.</h2><h1>/coursesidchange  PUT</h1><h2>* Change what course would be tought in, if it vaild and not already assigned</h2>'
