...
app.config.from_mapping(
        SECRET_KEY='dev',
        SQLALCHEMY_DATABASE_URI='postgresql://postgres@pg:5432/cms_db',
...
def infoUA():
    return '<h1>/useraccounts  GET</h1><h2>* retrieve all information on useraccounts.</h2><h1>/useraccount/<int:id>  GET</h1><h2>* retrieves useraccount information base on selected id</h2><h1>/useraccount  POST</h1><h2>*  Create new useraccount if the requirment are meet.</h2><h1>/useraccount  DELETE</h1><h2>*  Delete a existing useraccount, if one exist.</h2><h1>/useraccounts/<int:id>  PUT</h1><h2>* Edit slected useraccount if it exist.</h2>'
@app.route('/students/info')
def infoStu():
    return '<h1>/students  GET</h1><h2>* retrieve all information on students.</h2><h1>/useraccount/<int:id>  GET</h1><h2>* retrieves student information base on selected id</h2><h1>/students  POST</h1><h2>*  Creates a new student row, if the requirment are meet.</h2><h1>/students  DELETE</h1><h2>*  Delete a existing students info, if one exist.</h2><h1>/students/<int:id>  PUT</h1><h2>* Edit slected student info if it exist.</h2>'
@app.route('/professors/info')
def infoPro():
    return '<h1>/professors  GET</h1><h2>* retrieve all information on professors.</h2><h1>/professors/<int:id>  GET</h1><h2>* retrieves professor information base on selected id</h2><h1>/professors  POST</h1><h2>*  Create new professor row, if the requirment are meet.</h2><h1>/professors  DELETE</h1><h2>*  Delete a existing professor, if one exist.</h2><h1>/useraccounts/<int:id>  PUT</h1><h2>* Edit slected professor if it exist.</h2>/professors/<int:id>/course_pro  GET<h1></h1><h2>* Retrieves the course that the professor will teach, if they are</h2><h1>/professors/gradStudent  GET</h1><h2>* Retrieves all professors that are also grad students, if there are any</h2><h1>/professors/substitutes  GET</h1><h2>*  Retrieves all professors that are available for substituting, if there are any'
@app.route('/courses/info')
def infoCou():
    return '<h1>/courses  GET</h1><h2>* retrieve all information on courses.</h2><h1>/courses/<int:id>  GET</h1><h2>* retrieves course information base on selected id</h2><h1>/courses  POST</h1><h2>*  Create new course row if the requirment are meet.</h2><h1>/courses  DELETE</h1><h2>*  Delete a existing course, if one exist.</h2><h1>/courses/<int:id>  PUT</h1><h2>* Edit slected course if it exist.</h2><h1>/courses/<int:id>/students  GET</h1><h2>* Retrieves all students info that are signup for selected course, if there are any</h2><h1>/courses/<int:id>/pro_course  GET</h1><h2>Retrieves professor that will teach selected course, if one is assigned</h2><h1>/courses/<int:id>/room  GET</h1><h2>* Retrieves building info that the course will be in, if one is assigned</h2>'
@app.route('/buildings/info')
def infoBul():
    return '<h1>/buildings  GET</h1><h2>* retrieve all information on buildings.</h2><h1>/buildings/<int:id>  GET</h1><h2>* retrieves building information base on selected id</h2><h1>/buildings  POST</h1><h2>*  Create new building infomation if the requirment are meet.</h2><h1>/buildings  DELETE</h1><h2>*  Delete a existing building information, if one exist.</h2><h1>/buildings/<int:id>  PUT</h1><h2>* Edit slected building, if it exist.</h2><h1>/courses/<int:id>/change  PUT</h1><h2>* Change what course would be tought in, if it vaild and not already assigned</h2>'
